...
class EOL {
	...
	static void setLineWidth({int characterLineWidth = 70}) {
		...
		EOL.comboYellow_Gray_analyticsController +
	...
	static String comboLightGreen = '\x1b[92m\x1b[107m';
	static String comboMagenta_Gray_subscriberController = '\x1b[95m\x1b[100m';
	static String comboMagenta_White = '\x1b[95m\x1b[107m';
	static String comboLightRed_White = '\x1b[91m\x1b[107m';
	static String comboYellow_Gray_analyticsController = '\x1b[93m\x1b[47m';
	static String comboPurple_White = '\x1b[35m\x1b[107m';
	static String comboPurple_Black_NetworkHelper = '\x1b[35m\x1b[40m';
	static String comboLightGray_Yellow_movieController = '\x1b[90m\x1b[103m';
	static String comboLightGray = '\x1b[90m\x1b[43m';
	...
	static void printAllCombos() {
		List<Map> combos = [
			{'color': EOL.comboLightGray_Yellow_movieController,'name': 'comboLightGrayOverYellow'},
			{'color': EOL.comboLightGray, 'name': 'comboLightGrayOverOlive'},
			...
			{'color': EOL.comboLightGreen,'name': 'comboLightGreenOverWhite'},
			{'color': EOL.comboMagenta_Gray_subscriberController,'name': 'comboMagentaOverGray'},
			...
			{'color': EOL.comboYellow_Gray_analyticsController, 'name': 'comboYellowOverGray'},
			{'color': EOL.comboPurple_White, 'name': 'comboPurpleOverWhite'},
			{'color': EOL.comboPurple_Black_NetworkHelper, 'name': 'comboPurpleOverBlack'},
